...
- **상태:** v7.5 R1 산책길 대시보드 + 콜라주 2탭 — **프로덕션 배포 완료** (커밋 4ee1ab3, https://vision-board-web.vercel.app 10경로 200 + /moment 404 + 번들 신규 카피 3종 확인·구 카피 부재). 회귀 14스위트 319/319 PASS(verify-v75r1 27케이스 신설, v618b 아카이브). 회원가입 기획서 v7.5 개정(온보딩 종료 선택 화면 + 첫 사진 소프트 게이트 + 동의 2종 + 운영 가이드) — 구현은 R2
