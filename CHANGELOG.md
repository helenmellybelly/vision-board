...
- **상태:** v6.5 프로덕션 배포 완료 — 온보딩 비전 섹션 카피 개선 + 캐릭터 눈 CSS 패치
- **주요 기능:**
  - 🐿️ 토리 캐릭터 (꿈의 정원사) — Acts 0-4 구조
  - 온보딩 Act 0: 투명 배경 WebM 영상(280×280, contain) — ffmpeg colorkey 흰 배경 제거
  - 온보딩 Act 3: 비전 카드 제목 간결화 + CTA 카피 개선 ("그게 어떻게 가능한 건데? →")
...
- **알려진 이슈:** 눈 하얘짐 — CSS 패치 적용, ffmpeg similarity 재조정 필요 가능성 있음
