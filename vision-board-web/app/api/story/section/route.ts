...
// 유지하는 품질 규칙: 장면 중심(요약 금지) ❌/✅ 예시, 감정단어 금지(마무리 1회 예외),
// **볼드 1곳** (renderStory·image/describe의 storyBold 파이프라인 호환), 400-550자
...
2. 하루 중 가장 중요한 순간 1개 — 이 하루를 정의하는 장면
3. 저녁 — 하루를 정리하는 방식
4. 잠들기 전 — 내일 기대되는 것 한 줄, 그래서 몇 시쯤 자야겠다는 감각
